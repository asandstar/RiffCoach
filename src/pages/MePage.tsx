...
import { Calendar, BookOpen, Download, Upload, RotateCcw, Info, Sparkles } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <GlassCard className="p-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button className="flex items-center gap-3 p-4 bg-primary-light rounded-xl hover:bg-primary-subtle transition-all">
            <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center">
